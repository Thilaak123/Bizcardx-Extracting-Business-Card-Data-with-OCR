...
st.set_page_config(page_title="BizCardX",
                   ...
                   menu_items={'About': "This dashboard app is created by Thilaak!"}
                   )
...
if selected == 'Home':
    ...
    with col2:
        ...
        card_pic = Image.open(r"C:\Users\Avinash Bala\PycharmProjects\airbnb\icon.png")
    ...
    if image is not None:
        ...
        with col2:
            ...
            tab1, tab2, tab3 = st.tabs(
                [":blue[Extracted information using easyOCR]", "Modified Information", ":red[Upload to database]"], )
            with tab1:
                st.write(result)
            with tab2:
            ...
            with tab3:
                st.write(
                    ":violet[If you wish to upload the business card data and an image to a database.Please click the below button.]")
                ...
                if submit:
                    with st.spinner("Please wait...."):
                        ...
                        val = (
                        Card_holder_Name, Company_name, Designation, Phone, Email_id, Web_Url, Pincode, Address, City,
                        State, file_bytes)
            ...
            if st.button('Display Image'):
                with col2:
                    ...
                    if result1 is not None:
                        ...
                        st.error(
                            "Image not found for the given name and designation.Please choose the correct name and designation")
